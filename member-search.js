...
import { db, authReady } from "./firebase.js"; // ✅ ADD authReady

// ✅ IMPORTANT: Messenger in-app browser safe start
(async () => {
  try {
    await authReady; // ✅ Firestore read before persistence ready হলে monthly miss হতে পারে
  } catch {}
})();
...
(() => {
  ...
  // ✅ Theme toggle (simple + stable)  (kept single instance)
...
// ===============================
(async () => {
  // ✅ ensure auth persistence ready before any Firestore reads
